        ...
        <div className="w-full flex">
            <div>
                <div className="flex gap-3 mb-5">
                    ...
                    <p className="text-md">Priyashu Kashyap</p>
                    <p className="text-small text-default-500">priyashu977@gmail.com</p>
                    <p className="text-small text-default-500">Class- REC-A</p>
                    </div>
                </div>
                <Divider />
                <div className="py-5">
                    <div className="flex justify-between gap-4">
                        <div className="flex gap-4">
                            ...
                            <div className="text-sm">
                                ...
                                <p>Ashutosh Kumar, Priya Goswami</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div>
